 ...
 *  from backend server
 */
.service('CommService', ['dealsService','BusinessService','tagService','locationService','$http' ,'$cookieStore',function(dealsService,BusinessService,tagService,locationService,$http,$cookieStore) {
